...
class Scheduler():
    ...
    async def register_schedules(self):
        asyncio.ensure_future(self.water_level_schedule.start(self.schedule_manager, 5))
        asyncio.ensure_future(self.tds_schedule.start(self.schedule_manager, 5))
        asyncio.ensure_future(self.ph_schedule.start(self.schedule_manager, 5))
